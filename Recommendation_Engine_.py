...
import pandas as pd
#get the data
data=pd.read_csv('C:\\Users\\PUNIA\\Downloads\\ml-latest-small\\Dataset\\ratings.csv')
data.head(50)
...
#get the data
movie_titles_genre=pd.read_csv('C:\\Users\\PUNIA\\Downloads\\ml-latest-small\\Dataset\\movies.csv')
